...
public class JXMapKit extends JPanel
{
    ...
    public JXMapKit()
    {
        ...
        try
        {
            Icon minusIcon = new ImageIcon(JXMapKit.class.getResource(Globals.PATH_IMG_MINUS));
            this.zoomOutButton.setIcon(resizeIcon(minusIcon, 20.0));
            this.zoomOutButton.setText("");
            Icon plusIcon = new ImageIcon(JXMapKit.class.getResource(Globals.PATH_IMG_PLUS));
            this.zoomInButton.setIcon(resizeIcon(plusIcon, 20.0));
        ...
        mainMap.addPropertyChangeListener("center", (PropertyChangeEvent evt) -> {
        ...
        mainMap.addPropertyChangeListener("centerPosition", (PropertyChangeEvent evt) -> {
        ...
        mainMap.addPropertyChangeListener("zoom", (PropertyChangeEvent evt) -> {
        ...
        miniMap.setOverlayPainter((Graphics2D g, JXMapViewer map, int width1, int height1) -> {
...
g.dispose();
    ...
    private void initComponents()
    {
        ...
        zoomInButton.setIcon(new ImageIcon(JXMapKit.class.getResource(Globals.PATH_IMG_PLUS)));
        ...
        zoomOutButton.setIcon(new ImageIcon(JXMapKit.class.getResource(Globals.PATH_IMG_MINUS)));
    ...
    private WaypointPainter<Waypoint> addressLocationPainter = new WaypointPainter<Waypoint>()
    {
     ...
     /**
     * Resizes an Icon by a specified percentage.
     *
     * @param icon      The original Icon to resize
     * @param scalePercent The percentage to scale the icon (e.g., 50%)
     * @return A new Icon resized to the specified percentage
     */
    public static Icon resizeIcon(Icon icon, double scalePercent) {
        scalePercent=scalePercent/100.0;
        if (!(icon instanceof ImageIcon)) {
            throw new IllegalArgumentException("Icon must be an ImageIcon");
        }
        
        Image image = ((ImageIcon) icon).getImage();
        int newWidth = (int) (image.getWidth(null) * scalePercent);
        int newHeight = (int) (image.getHeight(null) * scalePercent);
