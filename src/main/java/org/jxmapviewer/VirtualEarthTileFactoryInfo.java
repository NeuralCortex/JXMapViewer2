...
public class VirtualEarthTileFactoryInfo extends TileFactoryInfo
{
     ...
     * Use road map
     */
    public final static MVEMode MAP = new MVEMode("Standard", "map", "r", ".png");
    ...
    {
        super("Virtual Earth "+mode.name, MIN_ZOOM_LEVEL, MAX_ZOOM_LEVEL, TOP_ZOOM_LEVEL, TILE_SIZE, false, false, "", "", "", "");
